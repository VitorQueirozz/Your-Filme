<?php 
    ...
    class ReviewDao implements ReviewDAOInterface {
        ...
        public function create(Review $review){
            ...
            $stmt = $this->conexao->prepare("INSERT INTO reviews (rating, review, movies_id, users_id) VALUES (:rating, :review, :movies_id, :users_id)");
        ...
        public function getMoviesReview($id){
            ...
            $stmt = $this->conexao->prepare("SELECT * FROM reviews WHERE movies_id = :movies_id");
        ...
        public function hasAlreadyReviewed($id, $userId){
            ...
            $stmt = $this->conexao->prepare("SELECT * FROM reviews WHERE movies_id = :movies_id AND users_id = :users_id");
